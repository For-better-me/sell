<template>
    <div class="ratings" ref="ratings">
        <div class="ratings-content">
          ...
          <split></split>
          <ratingselect :ratings= 'ratings' @ratingsfilter= 'ratingsFilter' @toggle= 'toggle'></ratingselect>
...
<style>
    ...
    .ratings .rating-wrapper .star-wrapper-rate{
        margin-bottom: 6px;
        font-size: 0;
    }
    .ratings .rating-wrapper .star-wrapper-rate .star{
        display: inline-block;
        margin-right: 6px;
        vertical-align: top;
    }
    .ratings .rating-wrapper .star-wrapper-rate .delivery{
        display: inline-block;
        vertical-align: top;
        line-height: 12px;
        font-size: 10px;
    ...
    .ratings .rating-wrapper .recommend .icon-thumb_up,.ratings .rating-wrapper .recommend .item{
        display: inline-block;
        margin: 0 8px 4px 0;
        font-size: 9px;
    }
    .ratings .rating-wrapper .recommend .icon-thumb_up{
        color: rgb(0, 160, 220)
    };
    .ratings .rating-wrapper .recommend .item{
        padding: 0 6px;
